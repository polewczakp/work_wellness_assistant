...
BREAK_FREE_MIN = int(os.environ.get("BREAK_FREE_MIN", 30))  # free portion per break
STANDUP_RESET_IDLE_MIN = int(os.environ.get("STANDUP_RESET_IDLE_MIN", 2))  # idle -> stood up
